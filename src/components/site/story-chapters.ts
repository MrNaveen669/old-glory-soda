...
export type StoryChapterId =
  "roadside-roots" | "bottling-works" | "town-rollout" | "corner-shop-crates";
...
export type StoryChapter = {
  ...
  prevChapter: { id: StoryChapterId; title: string };
  nextChapter: { id: StoryChapterId; title: string };
};
...
export const STORY_CHAPTERS: Record<StoryChapterId, StoryChapter> = {
  "roadside-roots": {
    ...
    paragraphs: [
      "It started under the broad shade of an ancient banyan tree. Our founder set down a handcrafted red wooden crate filled with ice cut from frozen river blocks, housing thick glass codd-neck bottles. Passersby would stop in the afternoon heat, press down on the glass marble seal, and listen to that crisp, legendary pop.",
